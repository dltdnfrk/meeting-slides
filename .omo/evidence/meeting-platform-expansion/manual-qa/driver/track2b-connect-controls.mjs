...
try {
  ...
  rec("T2B.3-http-providers-expose-key-input",
    httpRows.length === 2 && httpRows.every((p) => p.hasKeyInput === true),
    httpRows.map((p) => ({ id: p.id, hasKeyInput: p.hasKeyInput, badge: p.badge })));
