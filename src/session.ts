...
import type {
  ClientListener, ServerMessage, SlideUpdate, TranscriptEntry, TranscriptUpdate,
} from "./protocol.ts";

// Compatibility for existing server and domain consumers.
export type {
  AskUpdate, AttendeesUpdate, CaptionUpdate, CapturePhase, CaptureUpdate,
  ClientAction, ClientListener, CompileJobId, CompileUpdate, DetectUpdate,
  ExportJobId, ExportUpdate, JobStage, LineUpdate, MeetingConcluded,
  MeetingDetailUpdate, MeetingsUpdate, ProviderInfo, ProvidersUpdate,
  RefineUpdate, ReviewConfirmed, ReviewItemUpdated, ReviewUpdate,
  SavedUpdate, ServerMessage, SlideUpdate, StatusUpdate, SttModelInfo,
  SttModelsUpdate, TranscriptEntry, TranscriptUpdate,
} from "./protocol.ts";
...
export class MeetingSession {
  ...
  onChunk(chunk: TranscriptChunk): void {
    ...
    const entry: TranscriptEntry = {
      text: chunk.text,
      ts: chunk.ts,
      ...(chunk.audioStartMs === undefined ? {} : { audioStartMs: chunk.audioStartMs }),
      ...(chunk.audioEndMs === undefined ? {} : { audioEndMs: chunk.audioEndMs }),
